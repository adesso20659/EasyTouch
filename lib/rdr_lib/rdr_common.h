...
#define NUM_LOCK_IO         (A1)
#define CAPS_LOCK_IO        (A10)
#define SCROLL_LOCK_IO      (A9)
...
#define USER_LED_ON             (0)                       // 系统复位时背光灯效果
#define USER_LED_OFF            (1)                       // 系统复位时背光灯效果
#define USER_LED_ON_OFF         (USER_LED_ON)             // 系统复位时背光灯效果
...
#define WI_WIL	         QMK_WIRED_WIREDL_CH
...
typedef struct {
    ...
    uint8_t User_Led_On_Off;        // 用户自定义背光开关
...
uint16_t Debounce_Key_3s_Count;
...
#define USER_BlE_ID                 (0X004E)
#define USER_BlE1_NAME              "EasyTouch1300"
#define USER_BlE2_NAME              "EasyTouch1300"
#define USER_BlE3_NAME              "EasyTouch1300"
...
#define USER_BATT_SCAN_VOLUME       (3)

#define USER_BATT_HIGH_POWER        (2555)      //满电 2565 * 3.3 /4096 = 2.066 4.13V     实际电路存在压降。
#define USER_BATT_LOW_POWER         (2095)      //低电 2065 * 3.3 /4096 = 1.663 3.32V     即使键盘不开灯，电池满电4.2V
...
#define LED_BATT_INDEX          (95)
#define LED_LOW_POWER_INDEX     (95)
#define LED_CAP_INDEX           (58)
#define LED_WIN_L_INDEX         (91)
#define LED_KB_SIX_N_INDEX      (80)
#define LED_DEB_INDEX           (64)

#define LED_BLE_1_INDEX         (17)
#define LED_BLE_2_INDEX         (18)
#define LED_BLE_3_INDEX         (19)
#define LED_2P4G_INDEX          (20)
#define LED_USB_INDEX           (21)

#define LED_NUM_ON              {gpio_write_pin_high(NUM_LOCK_IO);}
#define LED_NUM_OFF             {gpio_write_pin_low(NUM_LOCK_IO);}
    
#define LED_CAPS_ON             {gpio_write_pin_high(CAPS_LOCK_IO);}
#define LED_CAPS_OFF            {gpio_write_pin_low(CAPS_LOCK_IO);}
    
#define LED_SCROLL_ON           {gpio_write_pin_high(SCROLL_LOCK_IO);}
#define LED_SCROLL_OFF          {gpio_write_pin_low(SCROLL_LOCK_IO);}
...
uint8_t  Reset_Point_Count;
// uint8_t  Win_Point_Count;
// uint8_t  Mac_Point_Count;
bool     Led_Flash_Busy;
bool     Led_Off_Start;
bool     Led_Power_Up;
