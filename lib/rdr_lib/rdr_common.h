...
#define INIT_ALL_SIX_KEY            (INIT_SIX_KEY)                                          // 全键
...
#define USER_BATT_HIGH_POWER        (2595)      //满电 2565 * 3.3 /4096 = 2.066 4.1V      实际电路存在压降。
#define USER_BATT_LOW_POWER         (1980)      //低电 2065 * 3.3 /4096 = 1.663 3.35V     即使键盘不开灯，电池满电4.2V
#define USER_BATT_STDOWN_POWER      (1855)      //关机 1865 * 3.3 /4096 = 1.502 3.1V      输入到板子也就只有4.1V左右

#define USER_BATT_DELAY_TIME        (100 * 25)  //25S
#define USER_TIME_3S_TIME           (300)       //3S
#define USER_TIME_2S_TIME           (200)       //2S
#define USER_TIME_500MS_TIME        (50)       //500ms
...
#define USER_BlE_ID                 (0X1037)
#define USER_BlE1_NAME              "EasyTouch 1500"
#define USER_BlE2_NAME              "EasyTouch 1500"
#define USER_BlE3_NAME              "EasyTouch 1500"
